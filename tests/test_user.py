...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        usstr = us.__str__()
        self.assertIn("[User] (004321)", usstr)
        self.assertIn("'id': '004321'", usstr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        us = User(id="543", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(us.id, "543")
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = "alxse"
        us.my_number = 98
        self.assertEqual("alxse", us.middle_name)
